      ...
      var ProjectsService = /*#__PURE__*/function () {
        function ProjectsService() {
          ...
          this.projects.push({
            ...
            description: ["Din-Din is a project for students community to find new people trough sharing dinners together.", "My role as an UX and UI designer was to create a self explanatory web-servis where a user can", "1. Publish an event and all information about his dinner meal", "2. Invite, check, accept or decline guests", "3. See events next to his location and apply for them", "I not only created a design, but also used knowladge of HTML, CSS and Bootstrap framework for fast prototyping"],
            projectTags: ["Web application design", "HTMP, CSS, Bootstrap", "Food and events"]
          });
          this.projects.push({
            id: 6,
