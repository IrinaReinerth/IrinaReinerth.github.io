    ...
    constructor() {
        ...
        this.projects.push({
            ...
            description: ["goal: Develop a fully new design concept based on the best UX & UI practices",
                "Elements created for the project: Home page, Grid Page, Product detail page, Inspiration Articles page, Accaunt area",
                "During this project we followed the 4 steps iteration process: Understanding the user, Idiation, Prototyping, Testing, Repeat.",
                "1. Understanding: First of all, we conducted the Marcet research, Compatitor Analysis and User Research. We defined 2 types of user behavior and based on them created several wariations most common user flows on the platform.",
                ...
                "Before we started Prototyping phase, we developed our design language with rules of fonts, colors, shapes and spacing",
                "3. Proototyping: Every week we were working on one particular page, going throught all 4 steps Understanding, Prototyping, Testing, Evaluation. The result of every week was Hi-Fidelity prototype  of a new page in sketch.",
                "4. Testing: We were doing user testing in Understanding phase and Usability test with the prototypes we Created",
                "5. Next steps: After the design month for MVP 1 we started to develop and AB test of what we have designed. It was the new Home page, Grid page and Product detail page. It took around a month to develop each page, we had to develop a lot of components from skratch like new Menu, filters, grid item, pagination and many more. After that we started working on redesign for MVP 2 which was scope of Inspiration pages, Account Area, Price alert and Brand page",
                "Team: 3 designers",
